...
public class App_CommTalk extends DesktopApplicationProvider
{	
	public static final String   CONTEXT_TYPE  	      = "COMM_TALK";
	public static final String   DEFAULT_TITLE 	      = "Critique Adrian";
	public static final String   DEFAULT_DESCRIPTION  = "Give Adrian Feedback on his Comm Talk (Be Gentle!).";
	...
	public static final String   DEFAULT_LOGO_PATH    = "http://vignette2.wikia.nocookie.net/rbooks/images/1/1e/Images11.jpg/revision/latest?cb=20120114033858";
	 ...
	 * @param port
	 */
	public App_CommTalk(GroupContextManager groupContextManager, CommMode commMode, String ipAddress, int port)
	{
	...
	{
		return new String[] { "WEBSITE=https://docs.google.com/forms/d/1XjAnO1ur8Lr8eiVsoePR27FoCeKL9kI0ljrORDmM_go/viewform" };
	}
	...
	public boolean sendAppData(String bluewaveContext)
	{
		...
		return this.getDistance(parser, 40.443575, -79.945546) < 0.15;
	}
